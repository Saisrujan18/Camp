...
export function Collab() {
    ...
    const getLinks = (link) => {
        return (
            <li className='bg-blue-400 rounded-lg p-4'> 
                <a href='/'> {link} </a>
            </li>
        )
    }
            ...
            <div className=" flex-grow flex-1 flex flex-col max-w-screen-lg p-3">
                ...
                <div className="m-4 pb-2 border-gray-200">
                    <div>
                            ...
                            <div className='flex'>
                                <button to='/collab' className='rounded-lg text-md m-2 pl-4 pr-4 p-1 hover:bg-blue-500 
                                transition duration-500 ease-in-out' onClick={() => {setShowInfo(true); setShowChat(false); setShowMembers(false)}}> Info </button>

                                <button to='/collab' className='rounded-lg text-md m-2 pl-4 pr-4 p-1 hover:bg-blue-500 
                                transition duration-500 ease-in-out' onClick={() => {setShowInfo(false); setShowChat(false); setShowMembers(true)}}> Members </button>

                                <button to='/collab' className='rounded-lg text-md m-2 pl-4 pr-4 p-1 hover:bg-blue-500 
                                transition duration-500 ease-in-out' onClick={() => {setShowInfo(false); setShowChat(true); setShowMembers(false)}}> Chat </button>
                ...
                <main className="flex-1 overflow-y-auto p-2 bg-blue-200">
                    {/* <div className="relative"> */}
                        <p className={'bg-blue-400 rounded-lg text-1xl p-2 m-2 ' + (showInfo ? "" : "hidden")}> {description} </p>
