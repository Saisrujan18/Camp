...
const styles = {
    ...
    BG:" bg-fixed w-screen",
    body:"flex flex-col justify-center min-h-screen h-full py-2 small:mx-4 medium:mx-4 large:mx-4",
    ...
    title:"patternTitle bg-darkBlue85  h-home-title-small medium_l:h-home-title rounded-t-lg w-auto cursor-default",
    ...
    font_camp:"font-bold text-whit subpixel-antialiased text-3xl medium_l:text-4xl px-4 self-center",
        ...
        return (
            <div className={styles.title_body}>
                ...
                <div className={styles.heading}>
                    ...
                    <div className={styles.font_camp}>Welcome to Camp</div>
                </div>
            </div>
        )
    }
